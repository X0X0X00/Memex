...
const fakeStats: StatsReport = {
  ...
  last_at: 1714435200,
  activity: {
    daily: [{ date: "2025-11-14", messages: 175, conversations: 12 }],
    busiest_day: { date: "2025-11-14", messages: 175, conversations: 12 },
    busiest_day_by_conversations: { date: "2025-11-14", messages: 175, conversations: 12 },
    by_hour: Array.from({ length: 24 }, (_, i) => (i === 14 ? 160 : 5)),
    by_hour_conversations: Array.from({ length: 24 }, (_, i) => (i === 14 ? 12 : 1)),
    by_weekday: [10, 60, 30, 30, 20, 80, 40],
    by_weekday_conversations: [2, 6, 3, 3, 2, 8, 4],
  },
  top_phrases: [],
  top_topics: [],
